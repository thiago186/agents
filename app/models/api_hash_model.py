"""
This module contains the API keys hashing methods used when the users create API keys 
to consume (via API) the agents they configured inside the web application
"""
